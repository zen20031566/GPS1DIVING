...
using UnityEngine.SceneManagement; //for respawn
...
public class PlayerOxygen : MonoBehaviour
{
    ...
    public float oxygenDecayRate = 5f;     //oxygen lost per second underwater
    public float oxygenRefillRate = 40f;   //oxygen gained per second at surface or air pocket
    ...
    [Header("Respawn")]
    public Transform respawnPoint; //insert surface spawn point here

    [Header("UI")]
    public Image oxygenBar_Filled;
    public Image oxygenBar_Back;

    [Header("Low Oxygen Effect")] //for black overlay when oxygen low
    public Image lowOxygenOverlay;  // UI overlay here (might change)
    public float lowOxygenThreshold = 35f;  //trigger when below this level
    public float flashSpeed = 3f;  //how fast it flashes
